...
<?php
    ...
    // Get random ID
    $userID = rand(1, 99999);
    $idQuery = "SELECT C_ID FROM CLIENT WHERE C_ID = '$userID'";
    ...
    $query = "INSERT INTO CLIENT (C_ID, Fname, Lname, Username, Password) VALUES ('$userID', '$Fname', '$Lname', '$username', '$password')";
